                ...
                <c:choose>
                                ...
                                <c:forEach begin="1" end="${requestScope.pag}" varStatus="loop">
                                    <c:choose>
                                        <c:when test="${loop.index == requestScope.actual}">
                                            ...
                                            <c:otherwise>
                                            <li><a href="${pageContext.servletContext.contextPath}/navProductos?opt=${opt}&param=${idCat}&pag=${loop.index}&ord=${requestScope.orden}&pxp=${requestScope.proxpag}">${loop.index}</a></li> 
                                            </c:otherwise>
                                        </c:choose>
                    ...
                    <c:otherwise>
                        <div class="datosContacto" style="margin: 50px 0px;">
                            <h2 class="text-center">No hay ${nombreCat} disponibles</h2>
                        </div>
