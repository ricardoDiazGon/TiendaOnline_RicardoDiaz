                ...
                <c:choose>
                    ...
                    <c:otherwise>
                        <c:if test="${sessionScope.usuario.tipo == 'u'}">
                            <li><a id='bienvenido' class="visible-lg visible-md">Bienvenido, <c:out value="${sessionScope.usuario.email}"/></a></li>
                        ...
                        <c:if test="${sessionScope.usuario.tipo == 'a'}">
                            <li class="visible-lg visible-md"><a id='bienvenido'>Bienvenido, <c:out value="${sessionScope.usuario.email}"/></a></li>
