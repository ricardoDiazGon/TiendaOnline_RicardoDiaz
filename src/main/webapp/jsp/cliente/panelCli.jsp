                            ...
                            <form id="datos-user" class="form-inline" role="form"  method="post" action="${pageContext.servletContext.contextPath}/registro">
                                ...
                                <c:if test="${requestScope.errorCliente != null and requestScope.errorCliente != 'ok'}">
                                    ...
                                    <div style="margin-bottom: 25px" class="form-group col-md-4">
                                        ...
                                        <input id="nombre" type="text" class="form-control" name="nombre" placeholder="Nombre" value="${sessionScope.cliente.nombre}${requestScope.nombre}" ${readonly}>                                        
                                    </div>

                                    <div style="margin-bottom: 25px" class="form-group col-md-4">
                                        <label for="apellidos" class="control-label">Apellidos</label>
                                        <input id="apellidos" type="text" class="form-control" name="apellidos" placeholder="Apellidos" value="${sessionScope.cliente.apellidos}${requestScope.apellidos}" ${readonly}>                                        
                                    </div>

                                    <div style="margin-bottom: 25px" class="form-group col-md-4">
                                        <label for="NIF" class="control-label">NIF</label>
                                        <input id="NIF" type="text" class="form-control" name="NIF" placeholder="NIF/DNI" ${readonly} value="${sessionScope.cliente.NIF}${requestScope.nif}">                                        
                                    </div>

                                    <div style="margin-bottom: 25px" class="form-group col-md-4">
                                        <label for="claveNueRep" class="control-label">Email</label>
                                        <input id="claveNueRep" type="text" class="form-control" name="email" placeholder="Email" ${readonly} value="${sessionScope.cliente.email}${requestScope.email}" />                                        
                                    </div>

                                    <div style="margin-bottom: 25px" class="form-group col-md-4">
                                        <label for="fechaNacimiento" class="control-label">Fecha de Nacimiento</label>
                                        <input id="fechaNacimiento" type="date" class="form-control" name="fechaNacimiento" ${readonly} value="${sessionScope.cliente.fechaNacimiento}${requestScope.fechaNacimiento}"/>
                                    </div> 
                                </div>
