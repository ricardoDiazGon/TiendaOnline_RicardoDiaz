            ...
            <body class="container-fluid">
                ...
                <div id="secciones" class="container row">
                    ...
                    <div class="col-md-offset-1 col-md-8">
                        <h3 class="text-center">Lista de productos con stock bajo</h3>
                        <div>
                                ...
                                <c:forEach begin="1" end="${requestScope.pag}" varStatus="loop">
                                    <c:choose>
                                        <c:when test="${loop.index == requestScope.actual}">
                                            ...
                                            <c:otherwise>
                                            <li><a href="${pageContext.servletContext.contextPath}/actualizarProAdm?pag=${loop.index}&stock=bajo">${loop.index}</a></li> 
                                            </c:otherwise>
                                        </c:choose>
